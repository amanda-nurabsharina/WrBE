...
func (h *RoleController) CreateRole(c *fiber.Ctx) error {
	...
	role, err := h.RoleService.CreateRole(c, req.Name, req.DisplayName, req.Description, req.AccessibleMenus)
	if err != nil {
		return fiber.NewError(fiber.StatusBadRequest, err.Error())
	}
...
func (h *RoleController) UpdateRole(c *fiber.Ctx) error {
	...
	role, err := h.RoleService.UpdateRole(c, id, req.DisplayName, req.Description, req.AccessibleMenus)
	if err != nil {
		return fiber.NewError(fiber.StatusBadRequest, err.Error())
	}
